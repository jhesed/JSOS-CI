...
$(function () {
    ...
    List.prototype = {
        ...
        _addItemControls: function ($li) {
            ...
            if (me.$options.enableTodoInfo) {
                $itemControlsDiv.append($('<div>', {
                    'class': 'info-todo todo-action',
                    html: '<i class="glyphicon glyphicon-info-sign" data-toggle="modal" data-target="#myModal"></i>'
                }).click(function () {
                    /* Jhesed -- To add Implementation */
