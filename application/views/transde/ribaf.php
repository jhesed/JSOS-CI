...
<div class="content_box">
    ...
    <h2 class="text-left" style="float:left;">Rizal Bible Art Festival</h2> <div class="fb-share-button" data-href="<?php echo $this->config->item('base_url').'transde/ribaf'; ?>" data-type="button_count"></div>
