		...
		echo "
			...
			";
					if ($this->input->cookie('sns_id', TRUE) ? true: false) {
						if(!$is_amened) {
							?>									
								<a class="amen_link" href="<?php echo $this->config->item('base_url')."prayer_wall/amen?id=".$id?>"><button class='amen'>Amen</button></a>
							<?php
						}
						else {
							?>
								<a class="amen_link" href="<?php echo $this->config->item('base_url')."prayer_wall/amen?id=".$id?>"><button class='amen' disabled>Amened</button></a>
							<?php
						}
					}
					else {
						?>									
							<button class='tooltip amen' title="Sign in to Amen a post"><a class="amen_link" href="<?php echo $this->config->item('base_url')."prayer_wall/amen?id=".$id?>">Amen</a></button>
