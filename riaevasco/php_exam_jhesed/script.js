...
$(document).ready(function(){
	...
	},"<font size = '2' color = 'red'>This field may only contain alpha-numeric characters</font>");
	...
	$("#sign_up_form").validate({
		...
		messages:{
			email:{
				required:"<font size = '2' color = 'red'> Email is required</font>",
				email: "<font size = '2' color = 'red'> Invalid Email format</font>"
			},
			username:{
				required:"<font size = '2' color = 'red'> Username is required</font>",
				regex: "<font size = '2' color = 'red'>Special characters not allowed </font>"
			},
			password_signup:{
				required: "<font size = '2' color = 'red'> Password is required </font>",
				minlength: "<font size = '2' color = 'red'> Password should be atleast 6 characters </font>" 
			},
			verify_password:{
				equalTo: "<font size = '2' color = 'red'>Passwords do not match</font>"
			}
		},
...
$(document).ready(function(){
	...
	$("#sign_up_form").validate({
		...
		messages:{
			...
			fname:{
				required:"<font size = '2' color = 'red'> First name is required</font>",
				regex: "<font size = '2' color = 'red'>Special characters not allowed </font>"
			},
			lname:{
				required:"<font size = '2' color = 'red'> Last name is required</font>",
				regex: "<font size = '2' color = 'red'>Special characters not allowed </font>"
			}
		},
		submitHandler:function(){
